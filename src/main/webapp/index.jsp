...
<body>
    ...
    <div class="container-fluid">
      <a class="navbar-brand" href="${pageContext.request.contextPath}/">UPMU</a>
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="${pageContext.request.contextPath}/employeeList/eList.do">페이지이동</a></li>
              <li><input type="button" value="조직도팝업" onclick="eListPop();" class="dropdown-item">팝업</li>
            </ul>
          </li>
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="${pageContext.request.contextPath}/mail/sendMailList.do">보낸 메일함</a></li>
              <li><a class="dropdown-item" href="${pageContext.request.contextPath}/mail/receiveMailList.do">받은 메일함</a></li>
            </ul>
          </li>
          <li class="nav-item">
            <a class="nav-link disabled" href="${pageContext.request.contextPath}/attendance/attendanceManage.do" tabindex="-1" aria-disabled="true">근태관리</a>
          </li>
          <li class="nav-item">
            <a class="nav-link disabled" href="${pageContext.request.contextPath}/chat/chatRoomList.do" tabindex="-1" aria-disabled="true">채팅</a>
          </li>
        </ul>
      </div>
    </div>
	...
	<main class="responsive-wrapper">
		...
		<div class="magazine-layout">
			...
			<div class="magazine-column">
				<article class="article">
					...
					<h2 class="article-title article-title--small">
						<a href="#" class="article-link">
							To Become
							<mark class="mark mark--secondary">Happier</mark>
			...
			<div class="magazine-column">
				...
				<article class="article">
					<small class="article-category"> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="28" height="22" viewBox="0 0 28 22">
            <defs>
            ...
            <g id="headphones" clip-path="url(#clip-headphones)">
          ...
          </svg> <span>Post Reports / Podcast</span>
					</small>
					<h2 class="article-title article-title--medium">
						<a href="#" class="article-link">
              ...
              <path d="M232.3125,114.34375,88.34375,26.35937A15.99781,15.99781,0,0,0,64,40.00781V215.99219a16.00521,16.00521,0,0,0,24.34375,13.64843L232.3125,141.65625a16.00727,16.00727,0,0,0,0-27.3125Z">
					...
					<div class="article-podcast-info">Apple Podcasts, Google Podcasts, Stitcher</div>
					<div class="article-author">
						<div class="article-author-img">
							<img src="https://assets.codepen.io/285131/author-3.png" />
						</div>
	...
	<script>
		function eListPop() {
			...
			window.open(
					"${pageContext.request.contextPath}/common/eListPop.do",
					"", option);
		}
	</script>
</body>
