      ...
      <div class="sign-form">
        <div class="sign-up-htm">
         ...
         <div class="emp_phone">
            ...
            <input id="empName" name="empPhone" type="text" class="emp_phone_input" placeholder="이름" required>
          </div>
          <div class="emp_phone">
            <label for="empPhone" class="emp_phone_">휴대폰</label>
            <input id="empPhone" name="empPhone" type="text" class="emp_phone_input" placeholder="숫자만 입력" required>
          </div>
         
          <div class="hr"></div>
          <div class="sign_up_button">
            <input id="search-id" type="submit" class="sign_up_button_" value="보내기">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="sign-form">
        <div class="sign-up-htm">
         ...
         <div class="emp_phone">
            ...
            <input id="empEmail" name="empPhone" type="text" class="emp_phone_input" placeholder="아이디" required>
          </div>
          <div class="hr"></div>
          <div class="sign_up_button">
            <input id="search-pw" type="submit" class="sign_up_button_" value="보내기">
          </div>
        </div>
      </div>
    </div>
